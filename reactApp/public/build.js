...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moviePage = __webpack_require__(167);

	var _moviePage2 = _interopRequireDefault(_moviePage);

	var _moviesPage = __webpack_require__(177);

	var _moviesPage2 = _interopRequireDefault(_moviesPage);

	var _moviesList = __webpack_require__(171);

	var _moviesList2 = _interopRequireDefault(_moviesList);

	var _filterBar = __webpack_require__(174);
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/', component: App },
	        _react2.default.createElement(_reactRouter.IndexRoute, { component: _moviesPage2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: 'menu', component: _menu2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: 'moviesPage', component: _moviesPage2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: 'moviePage/:id', component: _moviePage2.default })
	    )
	),
	        ...
	        value: function render() {
	            return (
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'footer',
	                        { id: 'footer', className: 'footer-distributed' },
	                        _react2.default.createElement(
	                            'section',
	                            { id: 'footerSection' },
	                            _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _movieDataSheet = __webpack_require__(168);

	var _movieDataSheet2 = _interopRequireDefault(_movieDataSheet);
	    ...
	    _createClass(MoviePage, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_movieDataSheet2.default, { title: this.state.movie.title,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieData = function (_Component) {
	    _inherits(MovieData, _Component);

	    function MovieData(props) {
	        _classCallCheck(this, MovieData);

	        return _possibleConstructorReturn(this, (MovieData.__proto__ || Object.getPrototypeOf(MovieData)).call(this, props));
	    }

	    _createClass(MovieData, [{
	        key: 'render',
	        value: function render() {
	            var titleStyle = { size: 30, fontFamily: 'Myriad Pro' };
	            var plotStyle = { width: '100%', fontSize: 16, display: 'inline-block' };
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'section',
	                    { id: 'movieDataSheetSection' },
	                    _react2.default.createElement(
	                        'section',
	                        { id: 'posterSection' },
	                        _react2.default.createElement('img', { id: 'pPoster', src: this.props.poster, width: '100%', align: 'top' })
	                    ),
	                    _react2.default.createElement(
	                        'section',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./movieDataSheet.scss", function () {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./movieDataSheet.scss");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html, body {\n  height: 100%;\n  font-family: \"Myriad Pro\"; }\n\n#movieDataSheetSection {\n  width: 100%;\n  margin-top: 3.5%; }\n\n#posterSection {\n  height: 100%;\n  width: 30%;\n  margin-left: 1%;\n  float: left;\n  display: inline-block; }\n\n#descriptionSection {\n  height: 100%;\n  width: 60%;\n  float: left;\n  margin-left: 2%;\n  display: inline-block;\n  color: white; }\n\n#iframeTrailer {\n  float: left; }\n\n#prevNext {\n  float: left; }\n\n.next li {\n  display: inline-block;\n  position: relative;\n  z-index: 100; }\n\n.next li a {\n  font-weight: 600;\n  text-decoration: none;\n  padding: 11px;\n  display: block;\n  color: #ffffff;\n  border: dashed;\n  -webkit-transition: all 0.2s ease-in-out 0s;\n  -moz-transition: all 0.2s ease-in-out 0s;\n  -o-transition: all 0.2s ease-in-out 0s;\n  -ms-transition: all 0.2s ease-in-out 0s;\n  transition: all 0.2s ease-in-out 0s; }\n\n.next li a:hover, .menu li:hover > a {\n  color: #ffffff;\n  background: #5383d3; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieList = function (_Component) {
	    ...
	    function MovieList(props) {
	        ...
	        _this.state = { movies: [], filter: '' };
	        _this.getMovies(_this.props.filtro, _this.props.genre);
	        return _this;
	    }
	    ...
	    _createClass(MovieList, [{
	        ...
	        key: 'getMovies',
	        value: function getMovies(fil, gen, text) {
	            switch (fil) {
	                case "All":
	                    this.loadAllMovies();
	                    break;
	        ...
	        */
	        ...
	        key: 'loadAllMovies',
	        value: function loadAllMovies() {
	            var url = 'http://localhost:8000/api/movies';
	            this.loadMovies(url);
	        }
	    }, {
	        key: 'loadBestRated',
	        value: function loadBestRated() {
	            var url = 'http://localhost:8000/api/movies?order=rating';
	            this.loadMovies(url);
	        }
	    }, {
	        key: 'loadLastReleased',
	        value: function loadLastReleased() {
	            var url = 'http://localhost:8000/api/movies?order=released';
	            this.loadMovies(url);
	        }
	    }, {
	        key: 'loadMoviesByGenre',
	        value: function loadMoviesByGenre(gen) {
	        ...
	        key: 'loadMoviesByText',
	        value: function loadMoviesByText(text) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                this.state.movies.map(function (m) {
	                    ...
	                    return _react2.default.createElement(
	                        'div',
	                        { key: m.id, className: 'responsive' },
	                        _react2.default.createElement(
	                            'div',
	                            { key: m.id, className: 'img' },
	                            _react2.default.createElement(
	                                _reactRouter.Link,
	                                { to: "moviePage/" + m.id },
	                                _react2.default.createElement('img', { key: m.id, src: m.poster })
	                            ),
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'desc' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./galleryImage.scss", function () {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./galleryImage.scss");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "div.img {\n  border: 1px solid #ccc; }\n\ndiv.img:hover {\n  border: 1px solid #777; }\n\ndiv.img img {\n  width: 100%;\n  height: auto; }\n\ndiv.desc {\n  padding: 15px;\n  text-align: center;\n  color: white; }\n\n* {\n  box-sizing: border-box; }\n\n.responsive {\n  padding: 0 6px;\n  float: left;\n  /*width: 24.99999%;*/\n  width: 16.66666%; }\n\n@media only screen and (max-width: 700px) {\n  .responsive {\n    width: 49.99999%;\n    margin: 6px 0; } }\n\n@media only screen and (max-width: 500px) {\n  .responsive {\n    width: 100%; } }\n\n.clearfix:after {\n  content: \"\";\n  display: table;\n  clear: both; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterBar = function (_Component) {
	    ...
	    _createClass(FilterBar, [{
	        ...
	        key: 'handleAllMovies',
	        value: function handleAllMovies(e) {
	            //alert('All');
	            this.props.changeFilter('All');
	            //alert('All');
	        }
	    }, {
	        key: 'handlePopularMovies',
	        value: function handlePopularMovies(e) {
	            this.props.changeFilter('Popular');
	            //alert('Popular');
	        }
	    }, {
	        key: 'handleReleasedMovies',
	        value: function handleReleasedMovies(e) {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { href: '#', id: 'allButton', onClick: this.handleAllMovies.bind(this) },
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { href: '#', id: 'popularButton', onClick: this.handlePopularMovies.bind(this) },
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { href: '#', id: 'recentButton', onClick: this.handleReleasedMovies.bind(this) },
	                                _react2.default.createElement('i', { className: 'icon-bullhorn' }),
	                                'RECENT'
	                            )
	                        ),
	                        _react2.default.createElement(
	                            'li',
	                            null,
	                            _react2.default.createElement(Genres, { genres: this.state.genres, selectedGenre: this.handleGenreChange.bind(this) })
	                        ),
	                        _react2.default.createElement(
	                            'li',
	                            null,
	                            _react2.default.createElement('input', { id: 'inputSearch', onChange: this.handleInputChange.bind(this) })
	                        )
	                    )
	                )
	            );
	...
	var Genres = function (_Component2) {
	    _inherits(Genres, _Component2);

	    function Genres(props) {
	        _classCallCheck(this, Genres);

	        return _possibleConstructorReturn(this, (Genres.__proto__ || Object.getPrototypeOf(Genres)).call(this, props));
	    }
	    ...
	    _createClass(Genres, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'select',
	                    { id: 'selectGenres', name: 'generos', defaultValue: 'All', onChange: this.props.selectedGenre.bind(this) },
	                    _react2.default.createElement(
	                        'option',
	                        { key: 'All', value: 'All' },
	                        'All'
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html body {\n  margin-left: auto;\n  margin-top: auto;\n  margin-right: auto;\n  margin-bottom: auto;\n  background-color: #33383b; }\n\nheader {\n  background-color: #292c2f; }\n\n.filterOptions {\n  display: block; }\n\n.filterOptions li {\n  display: inline-block;\n  z-index: 100; }\n\n.filterOptions li a {\n  font-weight: 600;\n  text-decoration: none;\n  padding: 11px;\n  display: block;\n  color: #ffffff;\n  -webkit-transition: all 0.2s ease-in-out 0s;\n  -moz-transition: all 0.2s ease-in-out 0s;\n  -o-transition: all 0.2s ease-in-out 0s;\n  -ms-transition: all 0.2s ease-in-out 0s;\n  transition: all 0.2s ease-in-out 0s; }\n\n.filterOptions li a:hover, .filterOptions li:hover > a {\n  color: #ffffff;\n  background: #5383d3; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MoviesPage = function (_React$Component) {
	    ...
	    function MoviesPage(props) {
	        ...
	        _this.state = { filtro: 'All', genre: '', text: '' };
	        return _this;
	    }

	    _createClass(MoviesPage, [{
	        key: 'changeFilter',
	        value: function changeFilter(fil) {
	            //alert('BIND OK');
	            //alert(fil);
	        ...
	        key: 'changeGenre',
	        value: function changeGenre(fil, gen) {
	            //alert('BIND OK');
	            //alert(fil);
	            //alert(gen);
	            this.setState({ filtro: fil });
	        ...
	        value: function changeInputSearch(fil, text) {
	            console.log(text);
	            //alert(fil);
	            this.setState({ filtro: fil });
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_filterBar2.default, { changeFilter: this.changeFilter.bind(this), changeGenre: this.changeGenre.bind(this), changeInputSearch: this.changeInputSearch.bind(this) }),
	                _react2.default.createElement(_moviesList2.default, { filtro: this.state.filtro, genre: this.state.genre, text: this.state.text })
	            );
	        }
	    }]);
